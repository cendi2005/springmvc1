...
public class BaseInterceptor3 implements HandlerInterceptor {
    ...
    static Logger logger = LogManager.getLogger(BaseInterceptor3.class.getName());
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
        ...
        logger.info("3 ************BaseInterceptor3 preHandle executed**********");
        return true;
    }
    ...
    public void postHandle(HttpServletRequest arg0, HttpServletResponse arg1, Object arg2, ModelAndView arg3)
        ...
        logger.info("************BaseInterceptor3:"+webContext.getBodyJsonString());    }
