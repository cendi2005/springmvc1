...
public class ModifyParametersFilter extends OncePerRequestFilter {
    static org.apache.logging.log4j.Logger logger = LogManager.getLogger(ModifyParametersFilter.class.getName());
